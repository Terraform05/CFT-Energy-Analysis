...
| `plots_corrected/` | Auto-generated PNGs for every figure (ignored by git). |
...
4. **Notebook execution** – Run interactively in Jupyter or headless:
   ...
   ```
   Executing the notebook refreshes every PNG in `plots_corrected/` and exports each plot’s dataset into `csv_plots/`.
...
## Findings
Visuals reside in `plots_corrected/`. Commentary summarises the behaviour shown by each figure.

### Hourly, Weekly, and Monthly Price Cyclicality
![Hourly price cyclicality](plots_corrected/price_hourly_avg.png)
![Weekly price cyclicality](plots_corrected/price_day_of_week.png)
![Monthly price cyclicality](plots_corrected/price_monthly_avg.png)
...
![Hourly load vs renewables](plots_corrected/hourly_load_vs_renewables.png)
![Monthly renewables and net load](plots_corrected/monthly_renewables_netload_price.png)
...
![Hourly renewable fuel](plots_corrected/renewables_fuel_hourly_line.png)
![Weekday renewable fuel](plots_corrected/renewables_fuel_weekday_line.png)
![Monthly renewable fuel](plots_corrected/renewables_fuel_monthly_line.png)
...
### Heatmaps
![Net load heatmap](plots_corrected/heatmap_net_load_weekday.png)
![Renewable heatmap](plots_corrected/heatmap_renewable_weekday.png)
...
![Hexbin net load vs price](plots_corrected/hexbin_netload_price_density.png)
...
![Scatter renewable share vs price](plots_corrected/price_vs_renewable_share_scatter.png)
![Binned renewable share vs price](plots_corrected/price_vs_renewable_share_binned.png)
...
### Rolling Correlation
![Rolling correlation](plots_corrected/rolling_corr_netload_price.png)
...
![Net load timeseries](plots_corrected/net_load_timeseries.png)
![Net load volatility](plots_corrected/net_load_volatility.png)
![Scatter by month](plots_corrected/scatter_net_load_price_month.png)
![Scatter by hour](plots_corrected/scatter_net_load_price_hour.png)
![Scatter by weekday](plots_corrected/scatter_net_load_price_weekday.png)
...
![Binned price vs net load](plots_corrected/binned_price_vs_net_load.png)
![Net load histogram](plots_corrected/net_load_hist.png)
...
![Regression fit](plots_corrected/regression_best_fit.png)
![Price residuals vs net load](plots_corrected/residuals_vs_net_load.png)
![Residuals vs renewable MW](plots_corrected/residuals_vs_renewable_output.png)
...
![Extreme events](plots_corrected/extreme_net_load_events.png)
...
### Autocorrelation
![Autocorrelation](plots_corrected/autocorr_price_net_load.png)
